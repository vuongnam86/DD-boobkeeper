import { defineComponent, inject, computed, createElementBlock, openBlock, unref, renderSlot, toValue } from "vue";
...
const _hoisted_1 = ["value", "disabled", "selected"];
...
//# sourceMappingURL=useFormSelect-DvaFh_iu.mjs.map
