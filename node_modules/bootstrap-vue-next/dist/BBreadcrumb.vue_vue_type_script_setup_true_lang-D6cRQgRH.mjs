...
import { _ as _sfc_main$2 } from "./BLink.vue_vue_type_script_setup_true_lang-Ct47WhzE.mjs";
      ...
      return openBlock(), createElementBlock("nav", {
        ...
        createElementVNode("ol", _hoisted_2, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(breadcrumbItemObjects.value, (item, i) => {
            return openBlock(), createBlock(_sfc_main$1, mergeProps({ key: i }, { ref_for: true }, item), {
              default: withCtx(() => [
...
//# sourceMappingURL=BBreadcrumb.vue_vue_type_script_setup_true_lang-D6cRQgRH.mjs.map
