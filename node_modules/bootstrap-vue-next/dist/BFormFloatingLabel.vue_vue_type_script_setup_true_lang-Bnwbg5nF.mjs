    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("datalist", { id: unref(computedId) }, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(normalizedOptsWrapper.value, (option, index) => {
          return openBlock(), createBlock(_sfc_main$2, mergeProps({ key: index }, { ref_for: true }, option), {
            default: withCtx(() => [
...
//# sourceMappingURL=BFormFloatingLabel.vue_vue_type_script_setup_true_lang-Bnwbg5nF.mjs.map
