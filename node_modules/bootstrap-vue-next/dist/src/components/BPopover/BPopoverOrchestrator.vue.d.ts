declare const _default: import('vue').DefineComponent<import('../../types/CommonTypes').TeleporterProps, {
    ...
    create: (obj: import('../..').OrchestratedPopover | import('../..').OrchestratedTooltip, tooltip?: boolean, options?: import('../..').OrchestratorCreateOptions) => import('../..').PromiseWithComponent<typeof import('./BPopover.vue').default | typeof import('..').BTooltip, import('../..').PopoverOrchestratorParam | import('../..').TooltipOrchestratorParam>;
    popover: (obj: import('../..').OrchestratedPopover, options?: import('../..').OrchestratorCreateOptions) => import('../..').PromiseWithComponent<({
        ...
        $slots: Readonly<import('../..').BPopoverSlots> & import('../..').BPopoverSlots;
    })), import('../..').PopoverOrchestratorParam | import('../..').TooltipOrchestratorParam>;
    tooltip: (obj: import('../..').OrchestratedTooltip, options?: import('../..').OrchestratorCreateOptions) => import('../..').PromiseWithComponent<({
        new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<Readonly<{
            modelValue?: Exclude<import('../..').BPopoverProps["modelValue"], undefined>;
        } & {
            body?: string | undefined;
