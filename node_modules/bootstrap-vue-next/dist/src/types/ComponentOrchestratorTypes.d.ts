...
export interface PromiseWithComponent<T, P> extends Promise<BvTriggerableEvent>, PromiseWithComponentInternal<T, P> {
}
...
export type ToastOrchestratorParam<ComponentProps = Record<string, unknown>> = Omit<BToastProps, 'modelValue'> & {
...
export type ToastOrchestratorCreateParam<ComponentProps = Record<string, unknown>> = MaybeRef<ToastOrchestratorParam<ComponentProps>>;
...
export type TooltipOrchestratorParam<ComponentProps = Record<string, unknown>> = Omit<BTooltipProps, 'body' | 'title' | 'modelValue'> & {
    'onUpdate:modelValue'?: (val: boolean) => void;
...
export type TooltipOrchestratorCreateParam<ComponentProps = Record<string, unknown>> = MaybeRef<TooltipOrchestratorParam<ComponentProps>>;
...
export type PopoverOrchestratorParam<ComponentProps = Record<string, unknown>> = Omit<BPopoverProps, 'body' | 'title' | 'modelValue'> & {
    'onUpdate:modelValue'?: (val: boolean) => void;
...
export type PopoverOrchestratorCreateParam<ComponentProps = Record<string, unknown>> = MaybeRef<PopoverOrchestratorParam<ComponentProps>>;
...
export type ModalOrchestratorParam<ComponentProps = Record<string, unknown>> = Omit<BModalProps, 'body' | 'title' | 'modelValue'> & {
    'onUpdate:modelValue'?: (val: boolean) => void;
...
export type ModalOrchestratorCreateParam<ComponentProps = Record<string, unknown>> = MaybeRef<ModalOrchestratorParam<ComponentProps>>;
