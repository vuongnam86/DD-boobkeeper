...
import { p as listGroupInjectionKey } from "./keys-BLeKMItg.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tagComputed = computed(
      () => parentData?.numbered.value ? "li" : props.button ? "button" : !isLink.value ? props.tag : _sfc_main$2
    );
...
//# sourceMappingURL=BListGroupItem.vue_vue_type_script_setup_true_lang-J0Ydbiva.mjs.map
