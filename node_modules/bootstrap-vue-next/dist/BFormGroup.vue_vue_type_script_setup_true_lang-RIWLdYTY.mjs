import { defineComponent, useSlots, useAttrs, toRef, ref, provide, computed, useTemplateRef, createBlock, openBlock, resolveDynamicComponent, normalizeStyle, normalizeClass, unref, withCtx, createVNode, createElementBlock, createCommentVNode, renderSlot, createTextVNode, toDisplayString, Fragment, mergeProps } from "vue";
        ...
        default: withCtx(() => [
          ...
          createVNode(unref(LabelContentTemplate).define, null, {
            default: withCtx(() => [
              slots.label || unref(props).label || isHorizontal.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                isHorizontal.value ? (openBlock(), createBlock(_sfc_main$4, mergeProps({ key: 0 }, { ...labelColProps.value, ...unref(props).labelWrapperAttrs }, { class: labelAlignClasses.value }), {
                  default: withCtx(() => [
          ...
          isHorizontal.value ? (openBlock(), createBlock(_sfc_main$5, {
            ...
            default: withCtx(() => [
              ...
              createVNode(_sfc_main$4, mergeProps({ ...contentColProps.value, ...unref(props).contentWrapperAttrs }, { ref: "_content" }), {
                default: withCtx(() => [
...
//# sourceMappingURL=BFormGroup.vue_vue_type_script_setup_true_lang-RIWLdYTY.mjs.map
